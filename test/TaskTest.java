...
class TaskTest {
    ...
    Task t1 = new Task(0, TypeOfTask.TASK,"t1", StatusOfTask.NEW,"d");
    int t1Id = taskManager.addTask(t1);

    Epic epic1 = new Epic(0,TypeOfTask.EPIC,"E1", StatusOfTask.NEW,"",new ArrayList<Integer>());
    int epic1Id = taskManager.addEpic(epic1);

    Subtask epic1subtask1 = new Subtask(0,TypeOfTask.SUBTASK,"Ep1S1", StatusOfTask.NEW,"",epic1Id);
    ...
    void immutabilityTask() {
        ...
        Task t2 = new Task(0,TypeOfTask.TASK,"t2", StatusOfTask.NEW,"e");
